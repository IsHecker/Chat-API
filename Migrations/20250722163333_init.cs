    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndividualConversations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IndividualConversations_AspNetUsers_User1Id",
                        column: x => x.User1Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_IndividualConversations_AspNetUsers_User2Id",
                        column: x => x.User2Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupConversation1Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupAdmins", x => new { x.AdminsId, x.GroupConversation1Id });
                    table.ForeignKey(
                        name: "FK_GroupAdmins_AspNetUsers_AdminsId",
                        column: x => x.AdminsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        column: x => x.GroupConversation1Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupMembers", x => new { x.GroupConversationId, x.MembersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndividualConversations_User1Id",
                table: "IndividualConversations",
                column: "User1Id");

            migrationBuilder.CreateIndex(
                name: "IX_IndividualConversations_User2Id",
                table: "IndividualConversations",
                column: "User2Id");
